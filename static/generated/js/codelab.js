...
var _user$project$BigQuery$getRowsResponseDecoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'result',
...
var _user$project$Routes$mysql = A2(
	...
	_Bogdanp$elm_route$Route$static('mysql'));
var _user$project$Routes$Home = {ctor: 'Home'};
var _user$project$Routes$home = A2(
	_Bogdanp$elm_route$Route_ops[':='],
...
var _user$project$Routes$match = function (_p0) {
	return A2(
		...
		_user$project$Routes$NotFound,
		A2(
			_Bogdanp$elm_route$Route$match,
			_user$project$Routes$sitemap,
...
var _user$project$Routes$toString = function (r) {
	...
	return A2(_elm_lang$core$Basics_ops['++'], '#', route);
};
...
var _user$project$Message$GetGithub = {ctor: 'GetGithub'};
var _user$project$Message$GetRank = {ctor: 'GetRank'};
var _user$project$Message$GetRankComplete = function (a) {
	return {ctor: 'GetRankComplete', _0: a};
};
var _user$project$Message$RouteTo = function (a) {
	return {ctor: 'RouteTo', _0: a};
};
var _user$project$Message$RouteChanged = function (a) {
...
var _user$project$Update$update = F2(
	function (msg, model) {
		...
		switch (_p0.ctor) {
			case 'RouteChanged':
				return A2(_user$project$Update$handleRoute, _p0._0, model);
			case 'RouteTo':
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					model,
					{
						ctor: '::',
						_0: _user$project$Routes$navigateTo(_p0._0),
						_1: {ctor: '[]'}
					});
			case 'GetRankComplete':
				if (_p0._0.ctor === 'Err') {
					var _p1 = _elm_lang$core$Native_Utils.crash(
						'Update',
						{
		...
		_elm_lang$html$Html$div,
		{
			...
			_1: {
				...
				_0: _elm_lang$html$Html_Attributes$style(
					{
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 'min-height', _1: '298px'},
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			}
...
var _user$project$View$link = F4(
	function (route, icon, label, expandable) {
			...
			_elm_lang$html$Html$a,
			{
				...
				_1: {
					...
					_0: A3(
						...
						opts,
						_elm_lang$core$Json_Decode$succeed(
							_user$project$Message$RouteTo(route))),
					_1: {ctor: '[]'}
				}
			},
			{
			...
			_0: A2(
				...
				},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Codelab'),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}),
...
var _user$project$Main$init = function (location) {
	var _p0 = _user$project$Model$init;
	var model = _p0._0;
	var route = _user$project$Routes$parsePath(location);
	return A2(
...
var _user$project$Main$parseRoute = function (_p1) {
	return _user$project$Message$RouteChanged(
		_user$project$Routes$parsePath(_p1));
};
