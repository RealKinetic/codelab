...
var _user$project$View$mysql = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html$text('Cloud SQL'),
			_1: {ctor: '[]'}
		});
};
				...
				_0: A2(
					...
					},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: A4(_user$project$View$link, _user$project$Routes$Home, 'fa fa-fw fa-desktop', 'Home', false),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							_0: A2(
								...
								{
									ctor: '::',
									_0: A4(_user$project$View$link, _user$project$Routes$MySQL, 'fa fw-fw fa-table', 'Cloud SQL', false),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}
